				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu color-gray" role="menu">
							...
							<li class="divider"></li>
							<?php  if(permission_check_account_user('see_system_upgrade')) { ?><li><a href="https://jq.qq.com/?_wv=1027&k=52WaYzG" target="_blank"><i class="wi wi-update color-gray"></i> 系统更新</a></li><?php  } ?>
