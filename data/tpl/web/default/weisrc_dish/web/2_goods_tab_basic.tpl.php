        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php  if($cur_store['default_jump'] == 2) { ?>
                        <label for="send_way" class="radio-inline"><input type="radio" name="send_way" value="1" id="send_way" <?php  if(empty($item) || $item['send_way'] == 1) { ?>checked="true"<?php  } ?> /> 外卖</label>
                        &nbsp;&nbsp;&nbsp;
                        <?php  } else { ?>

                        <label for="send_way" class="radio-inline"><input type="radio" name="send_way" value="2" id="send_way"  <?php  if(!empty($item) && $item['send_way'] == 2) { ?>checked="true"<?php  } ?> /> 邮递</label>
                        <?php  } ?>
                        <!-- <label for="send_way" class="radio-inline"><input type="radio" name="send_way" value="0" id="send_way"  <?php  if(!empty($item) && $item['send_way'] == 0) { ?>checked="true"<?php  } ?> /> 外卖和邮递</label> -->
                        <span class="help-block"></span>
                    </div>
                </div>
