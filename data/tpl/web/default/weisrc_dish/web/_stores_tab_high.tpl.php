<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane" id="tab_high">
    ...
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">用户下单后跳转提醒</label>
        <div class="col-sm-9">
            <div class="radio radio-info radio-inline">
                <input type="radio" id="is_order_tip1" value="1" name="is_order_tip" <?php  if($reply['is_order_tip']==1 || empty($reply)) { ?>checked<?php  } ?>>
                <label for="is_order_tip1"> 开启 </label>
            </div>
            <div class="radio radio-info radio-inline">
                <input type="radio" id="is_order_tip2" value="0" name="is_order_tip" <?php  if($reply['is_order_tip'] ==0) { ?>checked<?php  } ?>>
                <label for="is_order_tip2"> 关闭 </label>
            </div>
    ...
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">支付订单自动确认</label>
        <div class="col-sm-9">
            <div class="radio radio-info radio-inline">
            ...
            <div class="radio radio-info radio-inline">
                <input type="radio" id="is_auto_confirm2" value="0" name="is_auto_confirm" <?php  if(empty($reply['is_auto_confirm'])) { ?>checked<?php  } ?>>
    ...
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-md-2 control-label">餐后付款订单自动确认</label>
        <div class="col-sm-9">
            <div class="radio radio-info radio-inline">
                <input type="radio" id="is_order_autoconfirm1" value="1" name="is_order_autoconfirm" <?php  if($reply['is_order_autoconfirm']==1) { ?>checked<?php  } ?>>
                <label for="is_order_autoconfirm1"> 开启 </label>
            </div>
            <div class="radio radio-info radio-inline">
                <input type="radio" id="is_order_autoconfirm2" value="0" name="is_order_autoconfirm" <?php  if(empty($reply['is_order_autoconfirm'])) { ?>checked<?php  } ?>>
                <label for="is_order_autoconfirm2"> 关闭 </label>
            </div>
            <div class="help-block">
                餐后付款/货到付款订单自动为确认状态
            </div>
