<?php defined('IN_IA') or exit('Access Denied');?><div class="main" style="margin-top:0px;">
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class=""><a href="#tab_content" aria-controls="tab_content" role="tab" data-toggle="pill">商品详情</a></li>
                    ...
                    <li role="presentation" class=""><a href="#tab_time" aria-controls="tab_time" role="tab" data-toggle="pill">售卖时间</a></li>
                    <li role="presentation" class=""><a href="#tab_qrcode" aria-controls="tab_qrcode" role="tab" data-toggle="pill">销售二维码</a></li>
                </ul>
            </div>
        </div>
        <div class="tab-content">
            ...
            <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/goods_tab_time', TEMPLATE_INCLUDEPATH)) : (include template('web/goods_tab_time', TEMPLATE_INCLUDEPATH));?>
            <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/goods_tab_qrcode', TEMPLATE_INCLUDEPATH)) : (include template('web/goods_tab_qrcode', TEMPLATE_INCLUDEPATH));?>
        </div>
