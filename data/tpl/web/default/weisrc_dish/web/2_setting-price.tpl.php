    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">商户提现</label>
                <div class="col-sm-9">
                    <label for="is_open_price1" class="radio-inline"><input type="radio" name="is_open_price" value="1" id="is_open_price1" <?php  if(empty($setting) || $setting['is_open_price'] == 1) { ?>checked="true"<?php  } ?> /> 开启</label>
                    &nbsp;&nbsp;&nbsp;
                    <label for="is_open_price2" class="radio-inline"><input type="radio" name="is_open_price" value="0" id="is_open_price2"  <?php  if($setting['is_open_price'] == 0) { ?>checked="true"<?php  } ?> /> 关闭</label>
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">每单收取提现手续费</label>
                <div class="col-sm-6 col-md-8 col-xs-12">
                    <div class="input-group ">
                        <input type="text" name="one_order_getprice" class="form-control" value="<?php  echo $setting['one_order_getprice'];?>">
                        <span class="input-group-btn">
                            <button class="btn btn-default" type="button">元</button>
                        </span>
                    </div>
                    <span class="help-block">每个订单提现时减去的手续费，不填写为不收取手续费</span>
                </div>
            </div>
