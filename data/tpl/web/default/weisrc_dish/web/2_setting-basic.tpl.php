<?php defined('IN_IA') or exit('Access Denied');?><div class="tab-pane  active" id="tab_basic">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否显示虚拟下单信息</label>
                <div class="col-sm-9">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span> 达达key</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" id="dada_key" class="form-control" placeholder="" name="dada_key" value="<?php  echo $setting['dada_key'];?>">
                    <div class="help-block">
                        *请去http://newopen.imdada.cn申请
                    </div>
                </div>
            </div>
            
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span style='color:red'>*</span> 达达secret</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" id="dada_secret" class="form-control" placeholder="" name="dada_secret" value="<?php  echo $setting['dada_secret'];?>">
                    <div class="help-block">
                        *请去http://newopen.imdada.cn申请
                    </div>
                </div>
