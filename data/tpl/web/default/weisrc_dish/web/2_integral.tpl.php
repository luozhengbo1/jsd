...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'display' || empty($operation)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('integral', array('op' => 'display'))?>">平台优惠管理</a></li>
    <li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('integral', array('op' => 'post', 'storeid' => $storeid))?>">添加优惠</a></li>
    <li <?php  if($operation == 'send') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('integral', array('op' => 'send'))?>">平台发放优惠券</a></li>
    <li><a href="<?php  echo $this->createWebUrl('member', array('op' => 'display', 'storeid' => $storeid))?>">平台会员管理
    </a></li>
     <li><a href="<?php  echo $this->createWebUrl('outside', array('op' => 'display'))?>">平台外送设置</a></li>
</ul>
        ...
        <form action="" method="post" class="form-horizontal form">
            <div style="margin: 10px 0;display: none;" class="clearfix">
                <div class="btn-group pull-left" style="margin-right: 10px;">
                    <a class="btn btn-default <?php  if(empty($_GPC['attrtype'])) { ?>active<?php  } ?>" href="<?php  echo $this->createWebUrl('integral', array('op' => 'display', 'storeid' => $storeid))?>">全部</a>

                    <a class="btn btn-default <?php  if($_GPC['attrtype']==1) { ?>active<?php  } ?>" href="<?php  echo $this->createWebUrl('integral', array('op' => 'display', 'attrtype' => 1, 'storeid' => $storeid))?>">消费券(<?php  echo $type_count1;?>)</a>
                    <a class="btn btn-default <?php  if($_GPC['attrtype']==2) { ?>active<?php  } ?>" href="<?php  echo $this->createWebUrl('integral', array('op' => 'display', 'attrtype' => 2, 'storeid' => $storeid))?>">营销券(<?php  echo $type_count2;?>)</a>
                </div>
            </div>
            <div class="panel panel-default">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-default btn-sm pay" data-codeid="<?php  echo $coupon['id'];?>"> 赠送</a>
                                <!-- <a class="btn btn-default btn-sm pay" data-codeid="<?php  echo $coupon['id'];?>"
                                   href="javascript:void(0);" > 赠送</a> -->
                                <?php  } ?>
                                <a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('integral', array('op' => 'post', 'id' => $coupon['id'], 'storeid' => $storeid))?>">改</a>
                                <a class="btn btn-default btn-sm" onclick="return confirm('确认删除吗？');return false;"
                                   href="<?php  echo $this->createWebUrl('integral', array('op' => 'delete', 'id' => $coupon['id'], 'storeid' => $storeid))?>">删</i></a>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                访问链接:<?php echo $_W['siteroot'] . 'app/index.php?i=' . $coupon['weid'] . '&c=entry&id=' . $coupon['id'] . '&do=coupons&m=weisrc_dish'?>
                            </td>
                        </tr>
                        <?php  } } ?>
                        </tbody>
    ...
    <script>
        ...
        $(function () {
            $("tr").delegate(".pay", "click", function () {
                $("#idss").val($(this).attr("data-codeid"));
                console.log($(this).attr("data-codeid"));
    ...
    <div class="main">
        <div class="panel panel-default">
            <div class="panel-body">
                <a class="btn btn-warning" href="<?php  echo $this->createWebUrl('integral', array('op' => 'display', 'storeid' => $storeid))?>">返回优惠管理
                </a>
            </div>
        </div>
    ...
    <div class="main">
        ...
        <form action="" method="get" onsubmit="return check();" class="form-horizontal form" enctype="multipart/form-data">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">商户级别</label>
                        <div class="col-sm-9">
                            <select class="form-control" id="usertype" name="usertype" autocomplete="off">
                                <option value="0">全部级别</option>
                                <option value="1" <?php  if($usertype==1) { ?>selected<?php  } ?>>通用</option>
                                <option value="2" <?php  if($usertype==2) { ?>selected<?php  } ?>>部分商品</option>
                                <option value="3" <?php  if($usertype==3) { ?>selected<?php  } ?>>部分商家</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label class="radio-inline">
                                <input type="radio" name="type" value="0" <?php  if($type==0) { ?>checked="checked"<?php  } ?>/>所有商户
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" value="1" <?php  if($type==1) { ?>checked="checked"<?php  } ?>/>商品   SPU
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="type" value="2" <?php  if($type==2) { ?>checked="checked"<?php  } ?>/>门店
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group" id="print_label">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-block">
                                <code>可以按住ctrl键选择多个标签。</code>
                            </span>
                        </div>
                    </div>
                   <div class="form-group selectStoreid">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">设置门店</label>
                        <div class="col-sm-9">
                            <select class="form-control" style="margin-right:15px;height: 100% !important;" name="goodsid[]" autocomplete="off" multiple="true"
                                    size="10">
                                <option value="0" <?php  if(count($goodsids)==0) { ?>selected="selected"<?php  } ?>>全部门店 </option>
                ...
                <div class="panel-body">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                            <div class="col-sm-9">
                                <input name="btnupall" type="submit" value="发放优惠券" class="btn btn-primary col-lg-3" />
                                <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
                            </div>
                        </div>
                    </div>
        ...
        $(function(){
            ...
            $("input[name=btnupall]").click(function(){
                ...
                if(confirm("确认要操作吗?")){
                    ...
                    var url = "<?php  echo $this->createWebUrl('integral', array('op' => 'sendall', 'storeid' => $storeid))?>";
                    $.post(
                            url,
                            {
                                idArr:id,
            ...
            $(".selectStoreid").css("display","none");
            $("#print_label").css("display","none");
            $("input[name=type]").on('click',function(){
                if($(this).val()==1){
                    // alert(1);
                    $("#print_label").css('display','block');
                }else{
                     $("#print_label").css("display","none");
                }
                if($(this).val()==2){
                     $(".selectStoreid").css('display','block');
                }else{
                    $(".selectStoreid").css("display","none");
                }
            })
