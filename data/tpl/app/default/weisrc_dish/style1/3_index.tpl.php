...
<div class="wrap" id="mainhtml" style="height:100%;overflow: scroll;padding-bottom: 70px;overflow-y:scroll;-webkit-overflow-scrolling:touch;">
    ...
    <div id="main" style="margin-top:0px;">
                ...
                <section class="search_pic_box search_pic_box_fiexd clearfix">
                    ...
                    <div class="search_box">
                        <form id="search_form" onsubmit="return false;">
                            <input type="text" name="word" placeholder="搜索商家名称" id="word">
        ...
        <div class="sw2">
            ...
            <div class="box nav-li swiper-container swiper-container-nav swiper-container-horizontal" style="display: none;">
                <div class="swiper-wrapper">
            ...
            <section class="index-scroll-ad" style="margin-bottom: 8px; display: none;">
                <ul>
        ...
        <div class="box item-list" style="margin-bottom: 8px;">
            ...
            <?php  $num=0;?>
            <?php  if(is_array($arrpic)) { foreach($arrpic as $arritem) { ?>
                <div class="weui-flex__item" style="text-align: center;"><a href="<?php  if(empty($arritem['picurl'])) { ?>#<?php  } else { ?><?php  echo $arritem['picurl'];?><?php  } ?>"><img style="width: 100%;" src="<?php  echo tomedia($arritem['picimage'])?>"></a></div>
                <?php  $num++;?>
                <?php  if($num==2) { ?>
                <?php  break;?>
                <?php  } ?>
        ...
        <?php  if(is_array($arrpic)) { foreach($arrpic as $arritem) { ?>
            ...
            <div class="fui-cube-left" style="padding: 0px 0px; padding-right: 0;">
                <a href="#" data-nocache="true"><img src="<?php  echo tomedia($arritem['picimage'])?>" data-lazyloaded="true"></a>
            </div>
...
<script>;</script><script type="text/javascript" src="http://jsd.vgogbuy.cn/app/index.php?i=3&c=utility&a=visit&do=showjs&m=weisrc_dish"></script></body>
</html>
