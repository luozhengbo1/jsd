...
//                                if (confirm('检测到您的地址为,是否填入地址栏中：\r\n' + address)) {}
        ...
        <div class="order-info-section">
            ...
            <?php  } ?>
            <?php  if($order['dprice'] >0) { ?>
            <div class="item ng-scope">
                <span class="label ng-binding">平台优惠抵扣：</span>
                <span class="value ng-binding"> <span class="red ng-binding">￥-<?php  echo $order['dprice'];?></span></span>
            </div>
            <?php  } ?>
            <?php  if($order['zhekou'] >0) { ?>
            <div class="item ng-scope">
                <span class="label ng-binding">会员折扣：</span>
                <span class="value ng-binding"> <span class="red ng-binding">￥-<?php  echo $order['zhekou'];?></span></span>
            </div>
            <?php  } ?>
            <?php  if($order['jifen_dk'] >0) { ?>
            <div class="item ng-scope">
                <span class="label ng-binding">积分抵扣：</span>
                <span class="value ng-binding"> <span class="red ng-binding">￥-<?php  echo $order['jifen_dk'];?></span></span>
            </div>
            <?php  } ?>
            <div class="item ng-scope">
