...
<div  style="height: 100%;overflow:auto;overflow-y:scroll;-webkit-overflow-scrolling:touch;">
    ...
    <div id="user-profile-page" class="main-view ng-scope" style="padding-bottom: 60px;">
        <div id="top-user-avatar">
            <div class="avatar-section" style="background-color: <?php  echo $setting['style_base'];?>;">
                <div class="avatar">
            ...
            <div class="user-nav-section" style="background-color: <?php  echo $setting['style_base'];?>;">
        ...
        <div class="section promotion-nav-section">
            ...
            <a href="<?php  echo $this->createMobileUrl('mymember', array(), true)?>" class="arrow-right">
                <i class="fa fa-credit-card label-orange"></i> 会员卡
            </a>
        ...
        <div class="section copy-right-section">
            ...
            <a class="arrow-right" href="<?php  echo $this->createMobileUrl('adminstore', array(), true)?>">
                <i class="fa fa-cog label-red"></i> 商家门店管理
            </a>
            <?php  } ?>
            <?php  if($deliveryuser) { ?>
