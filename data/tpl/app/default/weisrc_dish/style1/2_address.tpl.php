        ...
        <div class="content native-scroll">
            <div class="list-block address-editor">
                ...
                <ul class="full-width-form">
					...
					<li class="item-content" id="tagmap">
                        <div class="item-inner">
                            <div id="map" style="width: 100%; height: 300px; overflow: hidden; position: relative; z-index: 0; color: rgb(0, 0, 0); text-align: left; background-color: rgb(243, 241, 236);">
							</div>
                        </div>
                    </li>
                    <li class="item-content">
                        <div class="item-inner">
                            ...
                            <div class="item-input input-address" style="padding-right:30px; line-height:21px" >
                                <textarea type="text" id="mapaddress" style="height: auto;line-height: normal;" name="mapaddress" value="<?php  echo $item['address'];?>"></textarea>
                            </div>
...
//        });
		var address ="<?php  echo $item['address'];?>";
		$('#mapaddress').val(address);
