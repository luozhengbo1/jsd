    ...
    <div class="main-view order-show ng-scope" id="delivery-order-show" style="padding-bottom: 80px;">
        ...
        <div class="section no-bottom-border">
            ...
            <div class="list-item ng-scope">
                ...
                <div class="quantity-info">
                    <span class="quantity ng-binding"><?php  echo $item['total'];?>(<?php  echo $item['unitname'];?>)</span>
                    <!--×-->
        ...
        <div class="order-info-section">
            ...
            <div class="item ng-scope" onclick="callphone()">
                ...
                <script>
                    function callphone(){
                        window.location.href = "tel:<?php  echo $order['tel'];?>";
                    }
                </script>
            </div>
            <?php  } ?>
        ...
        <div class="section">
            <div class="list-item ddb-form-control">
                ...
                <div class="input-field">
                    <input type="text" class="ddb-form-input ng-pristine ng-untouched ng-valid" style="border:1px solid #ffa39e;" placeholder="输入订单总价" value="<?php  echo $order['totalprice'];?>" name="totalprice" id="totalprice">
                </div>
            </div>
        </div>
...
<script>
    ...
    function updatepriceorder() {
        ...
        var t = $('#totalprice').offset().top;
        console.log(t);
        console.log('aaaa');
        window.scrollTo(0,t);


        if (confirm(`确定修改总价为${totalprice}元？`)) {
