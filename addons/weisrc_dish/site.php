...
//              'shop_no'=> '11047059',//门店编号
              ...
              'callback'=>$_W['siteroot'] . 'payment/dadacallback.php',
              );
    ...
    public function doMobileUserAddress()
    {
        ...
        $newmapurl = $this->createMobileUrl('useraddress',
            array('storeid' => $storeid,
                'mode' => $mode,
                'tablesid' => $tablesid,
                'op' => 'mapselecte', 'id' => $id, 'selectdate' => $selectdate, 'timeid' => $timeid, 'rtype' => $rtype), true);
        ...
        if ($operation == 'display') {
            ...
            $myValue = urldecode($_GPC["myValue"]) ;
            $item['address'] =$myValue?$myValue:$item['address'];
