...
// $c = $_GPC["c"];
 ...
 // print_r($this);
 // $data = pdo_fetchall("select * from".tablename($this->table_dispatcharea));
// print_r($data);
//  $data1 = array(
//     "weid"=>2,
//     "title"=>"hehe",
...
// $add = pdo_insert ($this->table_dispatcharea,$data1);
// echo $add;
// if(!empty($add)){
//     message("添加成功");
// }else{
...
// $delete = pdo_delete($this->table_dispatcharea,array("id"=>7));

// echo $delete;
// echo pdo_query($add,$params = array());
// $data2 = array(
// 	"title"=>"你好",
// );
// $update = pdo_update($this->table_dispatcharea,$data2,array("id"=>10));
// if(!empty($update)){
// 	message("修改成功");
// }else{
// 	message("修改失败");
