...
$coupons = pdo_fetch("SELECT * FROM " . tablename($this->table_coupons) . " where weid = :weid AND id=:id ORDER BY displayorder DESC LIMIT 1", array(':weid' => $weid, ':id' => $id));
...
include $this->template($this->cur_tpl . '/coupons');