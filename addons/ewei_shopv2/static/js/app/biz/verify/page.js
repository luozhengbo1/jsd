                  ...
                  $(".btn-search").click(function(){
                      ...
                      core.json('verify/page/search',{verifycode: $('#verifycode').val() },function(ret){
                            ...
                            if( ret.result.isverifygoods==1){
                                ...
                                $.router.load( core.getUrl('verify/verifygoods/detail',{id: ret.result.verifygoodid,verifycode: ret.result.verifycode }),true);
                                ...
                                $.router.load(core.getUrl(url, {id: ret.result.orderid, single: 1}), true);
                            }
