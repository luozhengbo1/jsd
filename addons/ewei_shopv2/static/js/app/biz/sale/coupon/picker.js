define(['core', 'tpl'], function (core, tpl) {
    var modal = {coupons: [], wxcards: [],contype: "",  wxid: 0,  wxcardid:"",  wxcode: "",  couponid: 0, couponname: '', merchid: 0};
    var Picker = function (params) {
        var self = this;
        self.params = $.extend({}, params || {});
        self.data = {coupons: self.params.coupons,wxcards: self.params.wxcards};
        self.show = function () {
