...
if ($operation == 'display') {
    ...
    $list = pdo_fetchall("select log.*, m.nickname,m.avatar,m.realname,m.mobile,g.title,g.thumb,g.thumb,g.credit,g.money,g.type as goodstype from " . tablename('ewei_shop_creditshop_log') . " log "
            ...
            . " where 1 {$condition} ORDER BY log.createtime desc limit " . ($pindex - 1) * $psize . ',' . $psize, $params);
