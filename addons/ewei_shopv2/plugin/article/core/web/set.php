...
class Set_EweiShopV2Page extends PluginWebPage {
    ...
    function main() {
        ...
        if ($_W['ispost']) {
            ...
            $article_image = save_media($_GPC['article_image']);	 // 转七牛
            ...
            $arr = array(
                ...
                'article_close_advanced' => $article_close_advanced
            );

            $data = array(
                'article_advanced' => $article_message,
                'article_close_advanced' => $article_close_advanced
            );
            m('common')->updatePluginset(array('article'=>array('tm'=>$data)));
