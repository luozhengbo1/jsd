            ...
            if(!empty($item)){
                ...
                if($item['showlevels']!='' && !empty($levels)){
                    ...
                    if($showlevels){
                        ...
                        unset($lindex, $level, $sindex, $showlevel);
                    }
                    if(!empty($viewlevels)){
                ...
                if($item['showgroups']!='' && !empty($groups)){
                    ...
                    if($showgroups!=''){
                        ...
                        unset($gindex, $group, $sindex, $showgroup);
                    }
                    if(!empty($viewgroups)){
                ...
                if($item['buylevels']!='' && !empty($levels)){
                    ...
                    if($buylevels2!=''){
                        ...
                        unset($lindex, $level, $bindex, $buylevel);
                    }
                    if(!empty($buylevels)){
                ...
                if($item['buygroups']!='' && !empty($groups)){
                    ...
                    if($buygroups2!=''){
                        ...
                        unset($gindex, $group, $bindex, $showgroup);
                    }
                    if(!empty($buygroups)){
                ...
                // 自定义表单
                if($item['diyformtype']==1 && !empty($item['diyformid']) && !empty($diyform)){    // 自定义
