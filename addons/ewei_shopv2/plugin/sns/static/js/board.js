define(['core', 'tpl', './face.js'], function (core, tpl, face) {
    var modal = {page: 1, bid: 0, cid: 0, keywords: '', listpage: 1};
    modal.init = function (params) {
        ...
        $('#btnFollow').click(function () {
            ...
            core.json('sns/board/follow', {bid: modal.bid}, function (ret) {
                if (ret.status == 0) {
    ...
    modal.getList = function () {
        core.json('sns/board/getlist', {page: modal.page, bid: modal.bid}, function (ret) {
    ...
    modal.bindEvents = function () {
        $('.like-good').unbind('click').click(function () {
            ...
            $(this).attr('stop');
            core.json('sns/post/like', {bid: modal.bid, pid: pid}, function (ret) {
                if (ret.status == 0) {
