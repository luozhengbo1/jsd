...
class Agent_EweiShopV2Page extends PluginWebPage {
    ...
    function main() {
        ...
        $sql = "select dm.*,dm.nickname,dm.avatar,l.levelname,p.id as pid,p.nickname as parentname,p.avatar as parentavatar,f.follow as followed, f.unfollowtime from " . tablename('ewei_shop_member') . " dm "
