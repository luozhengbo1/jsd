...
class Rank_EweiShopV2Page extends CommissionMobileLoginPage
{
    ...
    function ajaxpage()
    {
        ...
        $psize = 20;
        if ( $pindex*$psize >= $this->commission_rank['num'] )
        {
        ...
        {
            case '0':
                $this->commissionTotal($pindex,$psize);break;
            case '1':
                $this->commissionPay($pindex,$psize);break;
            case '2':
                $this->commissionVirtual($pindex,$psize);break;
        }
    }
