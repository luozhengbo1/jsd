    ...
    modal.init = function (params) {
        ...
        $('.btn-submit').click(function () {
            ...
            FoxUI.confirm(confirm_msg, function () {
                ...
                core.json('commission/apply', {type: applytype, realname: realname, alipay: alipay, alipay1: alipay1, bankname: bankname, bankcard: bankcard, bankcard1: bankcard1}, function (ret) {
                    if (ret.status == 0) {
