...
class Exhelper_EweiShopV2Page extends PluginWebPage {
    ...
    function getdata(){
        ...
        if($_W['ispost']){
            ...
            $sql = "select o.* ,a.realname ,m.nickname, d.dispatchname,m.nickname,r.refundstatus from " . tablename('ewei_shop_groups_order') . " o"
    ...
    function getorder(){
        ...
        if($_W['ispost']){
            ...
            $sql = "select o.* , a.realname,a.mobile,a.province,a.city,a.area, d.dispatchname,m.nickname,r.refundstatus from " . tablename('ewei_shop_groups_order') . " o"
                . " left join " . tablename('ewei_shop_groups_order_refund') . " r on r.orderid=o.id and ifnull(r.refundstatus,-1)<>-1"
                . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid "
                . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id "
                . " left join " . tablename('ewei_shop_dispatch') . " d on d.id = o.dispatchid "
            ...
            foreach ($list as &$value) {
                ...
                if (!is_array($addressa)) {
                    ...
                    $value['address'] = array(
                        'realname' => $addressa['realname'],
                        'nickname' => $value['nickname'],
                        'mobile' => $addressa['mobile'],
            ...
            $total = pdo_fetchcolumn(
                'SELECT COUNT(*) FROM ' . tablename('ewei_shop_groups_order') . " o "
                . " left join " . tablename('ewei_shop_groups_order_refund') . " r on r.orderid=o.id and ifnull(r.refundstatus,-1)<>-1"
                . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  "
                . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id "
                . " WHERE o.id in ( " . implode(',', $arr) . ") and o.uniacid={$_W['uniacid']}", $paras);
            $totalmoney = pdo_fetchcolumn(
                'SELECT sum(o.price) FROM ' . tablename('ewei_shop_groups_order') . " o "
                . " left join " . tablename('ewei_shop_groups_order_refund') . " r on r.orderid=o.id and ifnull(r.refundstatus,-1)<>-1"
                . " left join " . tablename('ewei_shop_member') . " m on m.openid=o.openid  "
                . " left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id "
                . " WHERE o.id in ( " . implode(',', $arr) . ") and o.uniacid={$_W['uniacid']}", $paras);
    ...
    function changestate(){
        ...
        if($_W['ispost']){
            ...
            foreach($arr as $i=>$data){
                ...
                // 查询出已打印次数
                $ordergood = pdo_fetch("SELECT id,goodid,printstate,printstate2 FROM " . tablename('ewei_shop_groups_order') . " WHERE goodid=:goodid and id=:orderid and uniacid=:uniacid limit 1",
                    array(':orderid'=>$orderid, ':goodid' => $ordergoodid,':uniacid' => $_W['uniacid']));
                if($type==1){
    ...
    function getorderinfo(){
        ...
        if($_W['ispost']){
            ...
            $orders = pdo_fetchall("SELECT o.id,o.orderno,o.addressid,o.address,o.status,o.pay_type,o.expresscom,o.expresssn,a.realname,a.mobile
                    ...
                    left join " . tablename('ewei_shop_member_address') . " a on o.addressid = a.id
                    WHERE o.id in( $in ) and o.status = 1 and (o.is_team = 0 or o.success = 1) and o.uniacid=:uniacid order by o.orderno desc ",
            ...
            foreach($orders as $i=>$order){
                ...
                if (is_array($orders[$i]['address_address'])) {
                    /*$orders[$i]['address_address']['realname'] = $order['realname'];
                    $orders[$i]['address_address']['mobile'] = $order['mobile'];*/
                }else{
                    $orders[$i]['address_address'] = array(
    ...
    function getdatabatch(){
        ...
        if($_W['ispost']){
            ...
            $sql = "select o.* ,a.realname ,m.nickname, d.dispatchname,m.nickname,r.refundstatus from " . tablename('ewei_shop_groups_order') . " o"
                ...
                . " left join " . tablename('ewei_shop_dispatch') . " d on d.id = o.dispatchid "
                . " where $condition $statuscondition ORDER BY o.createtime DESC  ";
            ...
            foreach($orders as $i=>$order){
                ...
                if(!is_array($order_address)){
                    ...
                    $orders[$i]['address'] = array(
                        'realname' => $member_address['realname'],
                        'nickname' => $member_address['nickname'],
                        'mobile' => $member_address['mobile'],
                        'province' => $member_address['province'],
                        'city' => $member_address['city'],
                        'area' => $member_address['area'],
