define(['core', 'tpl'], function (core, tpl) {
    ...
    modal.getList = function () {
        core.json('groups/orders/get_list', {page: modal.page, status: modal.status}, function (ret) {
            ...
            require(['../addons/ewei_shopv2/plugin/groups/static/js/op.js'], function (modal) {
