            ...
            if ($message_type == TM_ABONUS_PAY && empty($usernotice['abonus_pay'])) {
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '区域代理分红发放通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '您的区域代理分红已发放', "color" => "#000000"),
                ...
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '区域等级升级通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '您的区域代理等级从'.$data['oldlevel']['levelname'].'升级为'.$data['newlevel']['levelname']."特此通知！", "color" => "#000000"),
                        'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $openid;
                ...
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '成为区域代理通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '您已成为'.$aagenttype, "color" => "#000000"),
                        'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $openid;
