...
class Bonus_EweiShopV2Page extends AbonusMobileLoginPage
{
    ...
    function get_list()
    {
        ...
        $sql = "select b.*,m.aagenttype  from " . tablename('ewei_shop_abonus_billp') . " b "
              ." left join ".tablename('ewei_shop_member')." m on b.uniacid=m.uniacid and m.openid = b.openid "
        ...
        $total = pdo_fetchcolumn("select count(*)  from " . tablename('ewei_shop_abonus_billp') . " b "
              ." left join ".tablename('ewei_shop_member')." m on b.uniacid=m.uniacid and m.openid = b.openid "
