    ...
    protected function post() {
        ...
        if ($_W['ispost']) {
            $data = array(
                ...
                'goodschecked'=>intval($_GPC['goodschecked']),
                'commissionchecked'=>intval($_GPC['commissionchecked']),
                'changepricechecked'=>intval($_GPC['changepricechecked']),
                'finishchecked'=>intval($_GPC['finishchecked'])
            );
