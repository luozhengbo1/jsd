...
class Data_EweiShopV2Page extends MerchWebPage {
    ...
    function main() {
        ...
        $items = pdo_fetchall('SELECT d.*,m.avatar,m.nickname,m.realname,m.mobile,o.status  FROM ' . tablename('ewei_shop_virtual_data') . " d "
                . " left join " . tablename('ewei_shop_member') . ' m on d.openid<>\'\' and m.openid = d.openid and m.uniacid= d.uniacid '
                . " left join " . tablename('ewei_shop_order') . ' o on d.orderid<>0 and  o.id = d.orderid '
