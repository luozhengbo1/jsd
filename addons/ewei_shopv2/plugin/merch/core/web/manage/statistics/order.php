...
class Order_EweiShopV2Page extends MerchWebPage {
    ...
    function main() {
        ...
        $sql = "select o.*, a.realname as addressname,m.realname from " . tablename('ewei_shop_order') . ' o '
        ...
        $count = pdo_fetch("select count(o.id) as count from " . tablename('ewei_shop_order') . ' o '
            . " left join " . tablename('ewei_shop_member') . " m on o.openid = m.openid "
            . " left join " . tablename('ewei_shop_member_address') . " a on a.id = o.addressid "
