    ...
    public function sendMessage($sendData,$message_type)
    {
        ...
        if ($message_type == 'merch_apply' && empty($usernotice['merch_apply'])) {
            if($tm['is_advanced']){
                ...
                $message = array(
                    ...
                    'keyword2' => array('title' => '处理进度', 'value' => !empty($tm['merch_applytitle']) ? $tm['merch_applytitle'] : '商户入驻申请', "color" => "#000000"),
                    'keyword3' => array('title' => '处理内容', 'value' => !empty($tm['merch_apply']) ? $tm['merch_apply'] : '[商户名称]在[申请时间]提交了入驻申请。', "color" => "#000000"),
        ...
        if ($message_type == 'merch_apply_money' && empty($usernotice['merch_apply_money'])) {
            if($tm['is_advanced']){
                ...
                $message = array(
                    'first' => array('value' => $sendData['merchname'].'入驻申请', "color" => "#ff0000"),
                    'keyword2' => array('title' => '处理进度', 'value' => !empty($tm['merch_applymoneytitle']) ? $tm['merch_applymoneytitle'] : '商户提现申请', "color" => "#000000"),
                    'keyword3' => array('title' => '处理内容', 'value' => !empty($tm['merch_apply']) ? $tm['merch_apply'] : '[商户名称]在[申请时间]提交了提现申请,提现金额'. $sendData['money'] . '.[联系人] [手机号].', "color" => "#000000"),
                    'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                    'remark' => array('value' => "\n请到后台查看~", "color" => "#000000")
                );
