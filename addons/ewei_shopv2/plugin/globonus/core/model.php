            ...
            if ($message_type == TM_GLOBONUS_PAY && empty($usernotice['globonus_pay'])) {
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '分红发放通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '您的分红打款成功', "color" => "#000000"),
                ...
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '股东等级升级通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '您的股东等级从'.$data['oldlevel']['levelname'].'升级到'.$data['newlevel']['levelname'].',特此通知！', "color" => "#000000"),
                        'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $openid;
                ...
                if($tm['is_advanced']){
                    ...
                    $message = array(
                        ...
                        'keyword2' => array('title' => '处理进度', 'value' => '成为股东通知', "color" => "#000000"),
                        'keyword3' => array('title' => '处理内容', 'value' => '恭喜您成为股东', "color" => "#000000"),
                        'keyword1' => array('title' => '业务类型', 'value' => '会员通知', "color" => "#000000"),
                        'remark' => array('value' => "\n感谢您的支持", "color" => "#000000")
                    );
                    $toopenid = $openid;
