...
class DiyformModel extends PluginModel {
        ...
        foreach ($fields as $key => $value) {
            ...
            if ($data_type == 0) {
                ...
                if(!$array){
                    ...
                    elseif (is_array($memberdata[$key])){
                        $data[$key] = $memberdata[$key];
                    }
                    else{
                        $data[$key] = array();
            ...
            } else if ($data_type == 6 || $data_type == 7 || $data_type == 11) {
                $data[$key] = trim($memberdata[$key]);
            } else if ($data_type == 8 || $data_type == 12) {
                $data[$key] = array(0 => trim($memberdata[$key][0]), 1 => trim($memberdata[$key][1]));
            } else if ($data_type == 9) {
                if($array){
    ...
    public function getDatas($fields, $data, $flag = 0) {
        ...
        foreach ($fields as $key => $value) {
            ...
            } else if ($value['data_type'] == 3 || $value['data_type'] == 8 || $value['data_type'] == 12) {
    ...
    public function wxApp($fields, $f_data, $member=array()){
        ...
        if(!empty($fields) && is_array($fields)){
            foreach ($fields as $k=>$v){
                ...
                elseif ($v['data_type']==3 && is_array($f_data[$k])){
                    $newdata = array();
                ...
                elseif($v['data_type']==8 && !is_array($f_data[$k])){
                    $f_data[$k] = array();
                ...
                elseif($v['data_type']==10 && (empty($f_data[$k]) || !is_array($f_data[$k]))){
