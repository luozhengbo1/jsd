...
class PolyapiModel extends PluginModel {
    ...
    public function check_sign($array, $key_info) {
        ...
        $sign = $array['sign'];
        $appSecret=$key_info['appsecret'];    //appSecret的值通过在菠萝派中申请应用获得
...
//                $orders[$k]['taxamount'] = '';
//                $orders[$k]['tariffamount'] = '';
//                $orders[$k]['addedvalueamount'] = '';
//                $orders[$k]['consumptiondutyamount'] = '';
                $orders[$k]['sendstyle'] = '';
                $orders[$k]['qq'] = '';
