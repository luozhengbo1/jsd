    ...
    function main()
    {
        ...
        if ($_W['ispost']) {
            ...
            $params = array(
                'uniacid'=>$_W['uniacid'],
                'title'=>$_GPC['title'],
                'idcard1'=>trim($_GPC['idcard1']),
                'idcard2'=>trim($_GPC['idcard2']),
                'openid'=>$_W['openid'],
                'name'=>$_GPC['name'],
                'mobile'=>$_GPC['mobile'],
                'address'=>isset($_GPC['address'])?$_GPC['address']:'',
                'referrer'=>isset($_GPC['referrer'])?$_GPC['referrer']:'',
                'referrermobile'=>isset($_GPC['referrermobile'])?$_GPC['referrermobile']:'',
                'username'=>$_GPC['username'],
                'password'=>isset($_GPC['password'])?$_GPC['password']:'',
                'credit1'=>isset($_GPC['credit1'])?$_GPC['credit1']:0,
                'status'=>0,
            );
            if ($id){
