...
class Usesendtask_EweiShopV2Page extends ComWebPage {
    ...
    function main() {
        ...
        $usesendtasks = pdo_fetchall("SELECT cs.*, c.couponname as couponname , c.thumb as thumb,uc.couponname as usecouponname, uc.thumb as usethumb  FROM ".tablename('ewei_shop_coupon_usesendtasks').
            "  cs left  join  ".tablename('ewei_shop_coupon') ."  c on cs.couponid =c.id
    ...
    protected function post() {
        ...
        if ($_W['ispost']){
            ...
            $data = array(
                'uniacid' => $uniacid,
                'usecouponid' => intval($_GPC['usecouponid']),
