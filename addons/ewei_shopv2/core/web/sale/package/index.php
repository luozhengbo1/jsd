    ...
    protected function post() {
        ...
        if ($_W['ispost']){
            ...
            foreach($goodsid as $key => $value){
                ...
                if($good_data['merchid'] > 0 && $data['dispatchtype']==0){
                    ...
                    if(!empty($good_data['option'])){
                        ...
                        foreach($packageGoodsOption as $k => $val){
                            ...
                            $optionData = array(
                                ...
                                'title' => $op['title'],
                                'optionid' => $val,
                                'marketprice' => $op['marketprice'],
                                'packageprice' => $optionArray[0],
                                'commission1' => $optionArray[1],
                                'commission2' => $optionArray[2],
                                'commission3' => $optionArray[3]
                            );
