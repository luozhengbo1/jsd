...
class Verifygoods_EweiShopV2Page extends WebPage{
    ...
    function main() {
        ...
        $sql = 'select vg.*,g.id as goodsid ,g.title,g.thumb,o.ordersn,o.paytime,s.storename,o.openid  from '
            . tablename('ewei_shop_verifygoods') . '   vg
    ...
    function detail() {
        ...
        if ($_W['ispost']) {
            ...
            if(empty($limitnum)||$limitnum>$verifynum)
            {
                $used=0;
            }else{
                $used=1;
