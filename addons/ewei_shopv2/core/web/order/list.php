        ...
        if (!empty($list)) {
            ...
            foreach ($list as &$value) {
                ...
                $order_goods = pdo_fetchall('select g.id,g.title,og.title as gtitle,g.thumb,g.invoice,g.goodssn,og.goodssn as option_goodssn, g.productsn,og.productsn as option_productsn, og.total,
                    ...
                    og.diyformfields,op.specs,g.merchid,og.seckill,og.seckill_taskid,og.seckill_roomid,g.ispresell,g.costprice,op.costprice as option_costprice,og.expresssn,og.expresscom,og.express,og.sendtype from ' . tablename('ewei_shop_order_goods') . ' og '
