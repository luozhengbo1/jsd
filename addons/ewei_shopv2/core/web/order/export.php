    ...
    public function main() {
        ...
        if ($_GPC['export'] == 1) {
            ...
            if ($status != '') {
                ...
                $sql = "select o.* , a.realname as arealname,m.level,a.mobile as amobile,a.province as aprovince ,a.city as acity,a.area as aarea, a.street as astreet,a.address as aaddress,d.dispatchname,m.nickname,m.id as mid,m.realname as mrealname,m.mobile as mmobile,m.groupid,m.uid,sm.id as salerid,sm.nickname as salernickname,s.salername from " . tablename('ewei_shop_order') . " o"
